...
@app.route('/')
def index():
    return render_template_string(html_page, current_temperature=temperature, current_humidity=humidity, distance=distance, mode=mode, aircon_status=ledStates[0], heater_status=ledStates[1], dryer_status=ledStates[2])
